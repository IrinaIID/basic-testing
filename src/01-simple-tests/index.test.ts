...
describe('simpleCalculator tests', () => {
  ...
  test('should multiply two numbers', () => {
    ...
    expect(simpleCalculator({ a: 11, b: 3, action: Action.Multiply })).toBe(33);
  });
  ...
  test('should return null for invalid action', () => {
    expect(simpleCalculator({ a: 2, b: 3, action: '55' })).toBe(null);
  });

  test('should return null for invalid arguments', () => {
    expect(simpleCalculator({ a: 2, b: '63', action: Action.Add })).toBe(null);
  });
});
